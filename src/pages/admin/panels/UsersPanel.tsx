...
export function UsersPanel() {
  ...
  const load = async () => { if (isDataConfigured) setUsers(await getProfiles()) }
  useEffect(() => { void load() }, [])
  ...
  return <div className="admin-panel-stack"><div className="panel-intro"><div><h2>Utilisateurs admin</h2><p>Gerez les personnes autorisees a acceder au panneau.</p></div><button className="button primary small" onClick={() => setShowForm(true)} disabled={!isDataConfigured}><UserPlus /> Ajouter</button></div>
