    ...
    <section className="product-page content-section">
      ...
      <div className="product-detail">
        <div className="product-gallery">
          <div className="product-gallery-main">{displayedImage ? <img src={displayedImage} alt={variant ? `${product.name} - ${variant.value}` : images[activeImage]?.alt || product.name} /> : <ProductVisual product={product} />}</div>
